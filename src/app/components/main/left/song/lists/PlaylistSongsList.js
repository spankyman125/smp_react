...
export const PlaylistSongsList = memo(({ songs }) => {
  return <SongsList songs={songs} Render={PlaylistSongListItem}  />
})

const PlaylistSongListItem = memo(({ songs, index, playlists,...other }) => {
